...
<?php
    if(isset($_POST['submitbt']))
    {
      ...
      if($password==$cpassword)
      {
        ...
        {
          $query="insert into Primaryedu values('$username','$password','$cpassword','$dob','$mobile')";
          $query_run=mysqli_query($con,$query);
        }
...
<!--  <video autoplay loop muted poster id="background"><source src="Login Application/Videos/bk5.mp4" type="video/mp4"></video> -->
  <div class="container-fluid" id="nav">
    <div class="row">
      ...
      <img src="Images/vk2.jpg" height="40px" width="40px" data-target="#myModal4" data-toggle="modal" style="border-radius: 50%" />
      <img src="Images/imsp.jpg" height="40px" width="40px" data-target="#myModal3" data-toggle="modal" style="border-radius: 50%" />
    <!--  </ul>
      <ul class="nav navbar-nav navbar-right">  -->
      <button style="border-radius: 50%; height: 50px; width: 50px;" id="btn1">Login</button>
    ...
    <div class="dropdown-menu" style="margin-right: 10px;">
      <a class="dropdown-item" href="#">School Register/</a>
      <a class="dropdown-item" href="#">Teacher Register/</a>
      <a class="dropdown-item" href="#">Parents/Student_Reg</a>
    </div>
        ...
        <div class="modal-body" style="padding:40px 50px;">
          <form role="form" method="post" action="#">
            ...
            <div class="form-group">
              ...
              <input type="password" class="form-control" id="sname" name="sname" placeholder="Enter School Name" required />
            </div>
            <div class="form-group">
              <label for="teacher"><span class="glyphicon glyphicon-list-alt"></span> No. of teacher</label>
              <input type="password" class="form-control" id="teacher" name="teacher" placeholder="No. Of teacher" required />
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
             ...
             <div class="form-group">
              <label for="add"><span class="glyphicon glyphicon-home"></span> Address</label>
              <input type="text" class="form-control" id="add" name="add" placeholder="Address Here" required />
            </div>
             <div class="form-group">
              <label for="pin"><span class="glyphicon glyphicon-random"></span> Pin_Code</label>
              <input type="text" class="form-control" id="pin" name="pin" placeholder=" 00 00 00" required />
            </div>
            
              <button type="submit" name="submitbt" class="btn btn-success btn-block"><span class="glyphicon glyphicon-off"></span> Submit</button>
          </form>
        </div>
        <div class="modal-footer">
          <button type="submit" class="btn btn-danger btn-default pull-left" data-dismiss="modal"><span class="glyphicon glyphicon-remove"></span> Cancel</button>
...
<div class="container">
  <div class="modal fade" id="myModal4">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title">Designed By</h4>
          <button type="button" class="close" data-dismiss="modal">&times;</button></div>
